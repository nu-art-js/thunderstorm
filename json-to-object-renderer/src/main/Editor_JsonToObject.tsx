...
export class Editor_JsonToObject<T> extends TS_EditableContent<T, Props<T>, State> {
    ...
    render() {
        ...
        return <>
			...
			{isFreeTextMode && <TS_TextAreaV2 className={'ts-json-to-object'} resizeWithText data-valid={isValid} type="text" value={value} onChange={async (value) => {
