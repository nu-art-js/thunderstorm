...
class ModuleFE_Account_v2_Class
	...
	constructor() {
		...
		this.vv1 = {
			...
			login: apiWithBody(ApiDefBE_Account.vv1.login),
			logout: apiWithQuery(ApiDefBE_Account.vv1.logout),
			validateSession: apiWithQuery(ApiDefBE_Account.vv1.validateSession),
		};
	}
}
