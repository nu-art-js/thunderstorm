...
export class ATS_SessionData extends ComponentSync<ATS_SessionData_Props, ATS_SessionData_State> implements OnStorageKeyChangedListener {
    ...
    render() {
        ...
        return <LL_V_L className={'match_parent'}>
			...
			<TS_TextArea style={{ fontFamily: 'monospace', fontSize: 15 }} type="text" value={sessionDataAsJson} disabled/>
		</LL_V_L>;
    }
}
