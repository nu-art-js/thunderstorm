...
import {Request_RegisterProject} from "../../shared/apis";
import {PermissionsModule} from "./PermissionsModule";


export class PermissionsRegisterProject_Class
	extends Module {
...
export const PermissionsRegisterProject = new PermissionsRegisterProject_Class();