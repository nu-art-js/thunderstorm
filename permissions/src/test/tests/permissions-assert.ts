...
const requestPairWithLowerLevelsObj = {accessLevels: [lowerLevel], customField: customField1}
const requestPairWithHigherLevelsObj = {accessLevels: [higherLevel, lowerLevel], customField: customField1}
