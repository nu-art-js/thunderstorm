...
import { apiWithQuery, ModuleFE_Utils, } from "@nu-art/thunder-db-api-frontend/index";
...
export class ModuleFE_PermissionsAssert_Class extends Module<PermissionsModuleFEConfig> {
