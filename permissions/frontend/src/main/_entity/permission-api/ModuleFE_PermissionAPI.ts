...
import { ApiStruct_PermissionAPI, DBDef_PermissionAPI, DBProto_PermissionAPI } from '@nu-art/permissions-shared';
...
export class ModuleFE_PermissionAPI_Class extends ModuleFE_BaseApi<DBProto_PermissionAPI> implements ApiDefCaller<ApiStruct_PermissionAPI> {
