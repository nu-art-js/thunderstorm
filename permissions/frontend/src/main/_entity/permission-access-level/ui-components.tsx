...
import {createSelectableGenericDropDown, DBItemDropDownMultiSelector, TemplatingProps_TS_GenericDropDown, TS_MultiSelect_V2,} from '@nu-art/editable-item';
...
const Props_MultiSelect = DBItemDropDownMultiSelector.propsV3({
	...
	uiSelector: createSelectableGenericDropDown(Props_DropDown),
});

export const MultiSelect_PermissionAccessLevel = TS_MultiSelect_V2.prepare(Props_MultiSelect) as React.ComponentType<any>;
