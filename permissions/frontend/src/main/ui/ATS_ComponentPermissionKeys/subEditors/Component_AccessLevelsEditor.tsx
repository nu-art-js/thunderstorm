...
export class Component_AccessLevelsEditor extends ComponentSync<Props, State> {
    ...
    private renderLevelDropDown = () => {
        return <Permissions_DropDown.AccessLevel queryFilter={(item) => {
    ...
    render() {
        return (<LL_V_L className={'access-levels-section'}>
