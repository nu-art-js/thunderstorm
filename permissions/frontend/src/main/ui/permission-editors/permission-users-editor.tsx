...
class Component_EditAccount extends Component_BasePermissionItemEditor<DBProto_PermissionUser> {
    static defaultProps = {
    ...
    editorContent = () => {
        return <TS_PropRenderer.Vertical label={'Groups'}>
			<MultiSelect.Group className={'user-permission-groups'} editable={this.state.editable!} prop={'groups'}/>
		</TS_PropRenderer.Vertical>;
    };
}
class Controller_EditAccount extends TS_EditableItemControllerProto<DBProto_PermissionUser> {
...
export class PermissionUsersEditor extends Page_ItemsEditor<DBProto_PermissionUser> {
    //######################### Static #########################
