...
import { TS_EditableContent } from "@nu-art/thunder-routing/components/TS_EditableContent/TS_EditableContent";
...
export abstract class Component_BasePermissionItemEditor<Proto extends DBProto<any>, Props extends ItemEditor_Props<Proto> = ItemEditor_Props<Proto>, State extends ItemEditor_State<Proto> = ItemEditor_State<Proto>> extends TS_EditableContent<Proto, Props, State> {
    ...
    render() {
        ...
        return <>
			<div className={'item-editor__header'}>{editable.item._id ? this.props.displayResolver?.(editable.item) : `New ${this.props.module!.dbDef.entityName}`}</div>
