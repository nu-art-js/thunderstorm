	...
	domains: [
		{
			...
			levels: DuplicateDefaultAccessLevels(Domain_PermissionAssignment._id) as DefaultDef_AccessLevel[],
	...
	domains: [
		{
			...
			levels: DuplicateDefaultAccessLevels(Domain_PermissionManagement._id) as DefaultDef_AccessLevel[],
