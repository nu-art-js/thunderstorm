...
export class Example_CCgraphs_Renderer extends ComponentSync<Props, {
    data: D3ChartData[];
    tableData: TableData[];
}> {
        ...
        return <div>
			<div style={{ width: '100%' }}>
				<div style={{ float: 'left', width: '70%' }}>
					<Example_LineGraph data={this.state.data} frequency={86400000} startFromValue={50} axesLabels={{ x: this.axesLabelsX }} borderBoxValues={['90', '88', '92', '99', '89', '91', '90']} xDomain={7}/>
					<br />
				</div>
				<div style={{ float: 'left', width: '70%' }}>
					<Example_TableGraph frequency={1} rows={3} data={this.state.tableData} xDomain={7} axesLabels={{ x: this.axesLabelsX, y: ['Stress reduction', 'Physical'] }}/>
				</div>
			</div>
		</div>;
    }
