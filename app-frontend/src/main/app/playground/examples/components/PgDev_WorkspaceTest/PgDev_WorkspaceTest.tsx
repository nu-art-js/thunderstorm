...
const leftPanel = (props: {}) => <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%', width: '100%', background: '#ffccbb' }}>Left
	Panel</div>;
const rightPanel = (props: {}) => <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%', width: '100%', background: '#add8e6' }}>Right
	Panel</div>;
const centerPanel = (props: {}) => <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%', width: '100%', background: '#90ee90' }}>Middle
	Panel</div>;
const bottomPanel = (props: {}) => <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%', width: '100%', background: '#ffccbb' }}>Bottom
	Panel</div>;
const topPanel = (props: {}) => <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%', width: '100%', background: '#add8e6' }}>
	Top Panel</div>;
const panelRenderers: {
    [k: string]: React.ElementType;
} = {
...
class WorkspaceTest extends ComponentSync<Props, State> {
    ...
    render() {
        return <div style={{ width: '90vw', height: '85vh' }}>
			<TS_Workspace renderers={panelRenderers} workspaceKey={''}/>
			<div style={{ position: 'absolute', top: '100px', left: '20px' }}>
				<div onClick={() => {
                this.reDeriveState();
            }}>Reset Layout Config
				</div>
				<TS_DropDown adapter={SimpleListAdapter(configs, node => <div>{node.item.name}</div>)} onSelected={(item) => {
