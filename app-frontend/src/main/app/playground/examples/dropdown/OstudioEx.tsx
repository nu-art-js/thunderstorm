...
// type Plage1 = any & {optionLabel: keyof Plague}

// export class ItemRenderer
// 	extends BaseNodeRenderer<any & {optionLabel: keyof any}> {
//
// 	renderItem(item: Plague) {
// 		return (
// 			<div className="ll_h_c clickable match_width"
// 			     id={nodeProps.node.path}
// 			     style={(nodeProps.node.focused || nodeProps.node.selected) ? {backgroundColor: "white"} : {}}>
// 				<div className={optionRendererStyle(nodeProps.node.selected)}>
// 					<div className={`ll_h_c match_width`} style={{justifyContent: "space-between"}}>
// 						<div style={nodeProps.node.focused ? {fontWeight: "bold"} : {}}>{nodeProps.item.optionLabel}</div>
// 					</div>
// 				</div>
// 			</div>
// 		);
...
// const ItemRendererBuilder = (optionLabel: keyof any) => {
// 	const _label = optionLabel
// 	class ItemRenderer
// 		extends BaseNodeRenderer<any & {optionLabel: keyof any = _label}> {
//
// 		renderItem(item: Plague) {
// 			return (
// 				<div className="ll_h_c clickable match_width"
