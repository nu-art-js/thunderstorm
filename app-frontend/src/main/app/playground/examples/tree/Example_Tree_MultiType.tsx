...
import { Adapter, AdapterBuilder, NodeRendererProps, ModuleFE_Toaster, TS_Tree } from "@nu-art/thunder-db-api-frontend/index";
import { __stringify } from '@nu-art/ts-common';
export class Example_Tree_MultiType_Renderer extends Component<{}> {
    static index = 0;
    constructor(props: {}) {
        super(props);
    }
