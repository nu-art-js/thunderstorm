...
export class Example_Scatter_Renderer extends ComponentSync<{}, {
    data: Coordinates[];
}> {
    ...
    private circles = () => this.state.data.map((d, i) => (<circle key={i} r={5} cx={this.xScale()(d.x)} cy={this.yScale()(d.y)} style={{ fill: 'lightblue' }}/>));
    w = 600;
    h = 600;
    margin = {
        top: 40,
