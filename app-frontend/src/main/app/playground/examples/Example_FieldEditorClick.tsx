...
import { Example_NewProps, FieldEditorClick, FieldEditorClickProps } from "@nu-art/thunder-routing/index";
type TestType = {
    prop1?: string;
    prop2?: string;
};
class Example_FieldEditorClick_Renderer extends React.Component<{}, {
    instance: TestType;
}> {
    constructor(props: {}) {
        super(props);
