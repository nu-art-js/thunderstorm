...
export class Hello_Renderer extends ComponentSync<{}, {
    label: string;
    ...
    render() {
        return <>
			...
			<div className="ll_h_c"><h1 onClick={() => console.log('onclick')} onDoubleClick={ExampleModule.getMessageFromServer2}>Double click me</h1><LiveDoc docKey="double-mouse-click"/></div>
