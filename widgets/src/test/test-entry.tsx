...
import {TS_Checkbox} from '../main/checkbox/v1/TS_Checkbox.js';
...
import {TS_CollapsableContainer} from '../main/collapsable-container/v1/TS_CollapsableContainer.js';
...
import {Label as LabelV1} from '../main/label/v1/Label.js';
import {Label as LabelV3} from '../main/label/v3/index.js';
import {TS_Link as TS_LinkV1} from '../main/link/v1/TS_Link.js';
import {TS_Link as TS_LinkV3} from '../main/link/v3/TS_Link.js';
import {TS_Printable as TS_PrintableV1} from '../main/printable/v1/TS_Printable.js';
import {TS_Printable as TS_PrintableV3} from '../main/printable/v3/TS_Printable.js';
import {LL_V_L as LL_V_L_V1} from '../main/layouts/v1/Layouts.js';
import {LL_V_L as LL_V_L_V3} from '../main/layouts/v3/Layouts.js';
import {TS_CheckboxGroup as TS_CheckboxGroupV1} from '../main/checkbox-group/v1/TS_CheckboxGroup.js';
import {TS_CheckboxGroup as TS_CheckboxGroupV3} from '../main/checkbox-group/v3/TS_CheckboxGroup.js';
import {Button as ButtonV1} from '../main/button/v1/index.js';
import {Button as ButtonV3} from '../main/button/v3/index.js';
import {TS_ComponentTransition as TS_ComponentTransitionV1} from '../main/component-transition/v1/TS_ComponentTransition.js';
import {TS_ComponentTransition as TS_ComponentTransitionV3} from '../main/component-transition/v3/TS_ComponentTransition.js';
import {TS_CopyToClipboard} from '../main/copy-to-clipboard/v1/TS_CopyToClipboard.js';
import {TS_Toggle as TS_ToggleV1} from '../main/toggle/v1/TS_Toggle.js';
import {TS_Toggle as TS_ToggleV3} from '../main/toggle/v3/TS_Toggle.js';
import {TS_Slider as TS_SliderV1} from '../main/slider/v1/TS_Slider.js';
import {TS_Slider as TS_SliderV3} from '../main/slider/v3/TS_Slider.js';
import {TS_ReadMore as TS_ReadMoreV1} from '../main/read-more/v1/TS_ReadMore.js';
import {TS_ReadMore as TS_ReadMoreV3} from '../main/read-more/v3/TS_ReadMore.js';
import {TS_Radio as TS_RadioV1} from '../main/radio/v1/TS_Radio.js';
import {TS_Radio as TS_RadioV3} from '../main/radio/v3/TS_Radio.js';
import {TS_TextArea as TS_TextAreaV1} from '../main/textarea/v1/TS_TextArea.js';
