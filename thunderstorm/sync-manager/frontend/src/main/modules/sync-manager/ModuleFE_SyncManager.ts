 ...
 */
import { _keys, BadImplementationException, debounce, exists, filterDuplicates, flatArray, generateHex, Module, MUSTNeverHappenException, reduceToMap, removeFromArrayByIndex, removeItemFromArray, ResolvableContent, resolveContent, RuntimeModules, Second } from '@nu-art/ts-common';
import { apiWithBody, DataStatus, EventType_Query, ModuleFE_BaseApi, ModuleFE_ConnectivityModule, OnConnectivityChange, ThunderDispatcher } from "@nu-art/thunder-db-api-frontend";
import { ApiDef_SyncManager, DeltaSyncModule, FullSyncModule, LastUpdated, NoNeedToSyncModule, SmartSync_DeltaSync, SmartSync_FullSync, SmartSync_UpToDateSync, SyncDataFirebaseState, SyncDbData, SyncManagerAPI_SmartSync } from '@nu-art/thunderstorm-sync-manager-shared';
...
export class ModuleFE_SyncManager_Class extends Module implements OnConnectivityChange {
