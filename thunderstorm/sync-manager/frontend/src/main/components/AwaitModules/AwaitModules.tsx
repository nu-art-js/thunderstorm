...
import { ComponentSync, DataStatus, LL_H_C, LL_V_L, ModuleFE_BaseDB, ThunderDispatcher, TS_ProgressBar } from "@nu-art/thunder-routing";
...
export class AwaitModules extends ComponentSync<Props, State> implements OnSyncStatusChangedListener<any>, QueryAwaitedModules {
    // ######################### Life Cycle #########################
