...
import {createBodyServerApi} from '@nu-art/thunderstorm-backend/core/typed-api';
import {addRoutes} from '@nu-art/thunderstorm-backend/modules/ModuleBE_APIs';
import {ModuleBE_BaseDB} from '@nu-art/thunderstorm-backend/modules/db-api-gen/ModuleBE_BaseDB';
...
export class ModuleBE_SyncManager_Class
	...
	implements OnModuleCleanupV2, OnDatabaseChange {
