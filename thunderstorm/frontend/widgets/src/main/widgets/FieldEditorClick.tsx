...
export class FieldEditorClick extends ComponentSync<FieldEditorClickProps, State> {
    ...
    render() {
        return (<div style={{ width: '100%' }} onClick={this.props.clicks === 1 ? this.startEdit : undefined} onDoubleClick={this.props.clicks === undefined || this.props.clicks === 2 ? this.startEdit : undefined} onBlur={() => this.handleSave()} {...this.props.labelProps}>
				<FieldEditor id={this.props.id} type={this.props.type} editorType={this.props.editorType} isEditing={this.state.isEditing} inputProps={this.props.inputProps} labelProps={this.props.labelProps} onCancel={this.endEdit} onAccept={this.handleSave} storageKey={this.state.storageKey} value={this.props.value}/>
			</div>);
    }
}
