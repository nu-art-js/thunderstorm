...
export class FieldEditor extends ComponentSync<FieldEditorProps> {
    ...
    private renderInput = (value: string) => {
        // @ts-ignore
        return (<TS_Input {...(this.props.inputProps as TS_InputProps<any>)} focus={true} id={this.props.id} type={this.props.type} onAccept={this.props.onAccept} value={value} onChange={this.onChange}/>);
    };
    renderArea = (value: string) => {
        // @ts-ignore
        return (<TS_TextArea {...this.props.inputProps} focus={true} id={this.props.id} type={this.props.type} onAccept={this.props.onAccept} value={value} onChange={this.onChange}/>);
    };
    private renderLabel = () => {
