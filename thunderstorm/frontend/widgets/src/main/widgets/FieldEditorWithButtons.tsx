...
export class FieldEditorWithButtons extends ComponentSync<Props, State> {
    ...
    render() {
        ...
        return (<div className={`ll_h_c`} style={{ justifyContent: 'space-between' }}>
				<div>
					<FieldEditor id={this.props.id} type={this.props.type} isEditing={this.state.isEditing} inputProps={this.props.inputProps} labelProps={this.props.labelProps} onAccept={this.handleSave} onCancel={this.handleCancel} storageKey={this.state.storageKey} value={this.props.value}/>
				</div>
