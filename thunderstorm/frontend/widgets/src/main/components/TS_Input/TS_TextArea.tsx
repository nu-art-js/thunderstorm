...
export class TS_TextArea<Key extends string> extends TS_BaseInput<Key, TS_TextAreaProps<Key>, HTMLTextAreaElement> {
    componentDidMount() {
    ...
    render() {
        ...
        return <textarea {...props} ref={input => {
            ...
            }} disabled={this.props.disabled} name={this.props.name || this.props.id} key={this.props.id} id={this.props.id} className={_className('ts-textarea', this.props.className)} style={this.props.style} value={this.state.value} placeholder={this.props.placeholder} onChange={this._changeValue} onKeyDown={this.props.onKeyDown || this.onKeyDown} autoComplete={this.props.autoComplete ? 'on' : 'off'} spellCheck={this.props.spellCheck}/>;
    }
}
