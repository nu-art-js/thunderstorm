...
export class TS_Table<R extends TS_Object, A extends string = never> extends React.Component<Props_Table<R, A>, any> {
    static defaultProps = {
    ...
    render() {
        ...
        return (<table id={this.props.id} {...tableProps} className={_className('ts-table', tableProps?.className)}>
    ...
    private renderTableHeader() {
        ...
        return (<tr key={`${this.props.id}-0`} {...tablePropsTR} className={classNameTR}>
    ...
    private renderTableBody() {
        ...
        return this.props.rows.map((row, rowIndex) => {
            ...
            const classNameTR = _className('ts-table__tr', tablePropsTR?.className);
            return (<tr key={`${this.props.id}-${rowIndex}`} {...tablePropsTR} className={classNameTR}>
                    ...
                    return <td key={`${this.props.id}-${columnIndex}`} {...tablePropsTD} className={classNameTD} style={style}>
