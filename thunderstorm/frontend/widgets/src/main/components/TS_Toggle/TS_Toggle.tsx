...
export class TS_Toggle extends ComponentSync<Props, State> {
    ...
    render() {
        ...
        return <div id={this.state.id} onClick={this.updateCheckedStatus} className={containerClassName}>
			<input onChange={voidFunction} className={'ts-toggle__checkbox'} type={'checkbox'} checked={this.state.checked}/>
