...
export class TS_CheckboxV2 extends ComponentSync<Props, State> {
    ...
    private render_Input = () => {
        ...
        return <input type={'checkbox'} id={this.state.id} disabled={this.state.disabled} onChange={this.onChange} checked={!!this.state.checked} aria-checked={ariaChecked}/>;
    };
    private render_Icon = () => {
