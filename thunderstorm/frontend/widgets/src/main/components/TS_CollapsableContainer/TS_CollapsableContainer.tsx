...
export class TS_CollapsableContainer extends ComponentSync<Props, State> {
    ...
    render() {
        ...
        return <LL_V_L className={className} style={this.props.style} id={this.props.id} onMouseOver={this.props.onMouseOver} onMouseEnter={this.props.onMouseEnter} onMouseLeave={this.props.onMouseLeave} innerRef={this.props.innerRef}>
			{this.renderHeader()}
