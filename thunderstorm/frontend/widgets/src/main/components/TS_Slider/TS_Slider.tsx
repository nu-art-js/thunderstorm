...
export class TS_Slider extends ComponentSync<Props, State> {
    // ######################### Life Cycle #########################
    ...
    private renderSliderInput() {
        return <input type={'range'} value={this.state.value ?? this.props.min} min={this.props.min} max={this.props.max} onChange={this.onValueChange} onMouseUp={this.onMouseUp} style={{ backgroundSize: `${this.calculateBGSize()}% 100%` }}/>;
    }
    render() {
