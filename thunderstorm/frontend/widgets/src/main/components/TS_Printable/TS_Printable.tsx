...
export class TS_Printable extends React.Component<Props> {
    ...
    render() {
        ...
        return (<div {...props} className={_className('ts-printable', props.className, printOnly ? 'print-only' : undefined)} ref={(async (ref) => {
                if (this.ref)
                    return;
