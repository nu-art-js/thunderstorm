...
import { LL_H_C, LL_V_L, _className } from "@nu-art/thunder-routing";
...
export type Props_TS_MultiSelect_V2<Binder extends Binder_MultiSelect<any, any, any>> = StaticProps_TS_MultiSelect_V2<Binder['InnerType']> & DynamicProps_TS_MultiSelect_V2<Binder['EnclosingItem'], Binder['Prop']>;
...
export class TS_MultiSelect_V2<Binder extends Binder_MultiSelect<any, any, any>> extends Component<Props_TS_MultiSelect_V2<Binder>, any> {
    ...
    static prepare<EnclosingItem, K extends keyof EnclosingItem, InnerType>(_props: StaticProps_TS_MultiSelect_V2<InnerType>) {
        return <EnclosingItem_, Prop extends SubsetKeys<keyof EnclosingItem_, EnclosingItem_, InnerType[] | undefined>>(props: DynamicProps_TS_MultiSelect_V2<EnclosingItem_, Prop> & Partial<StaticProps_TS_MultiSelect_V2<InnerType>>) => <TS_MultiSelect_V2<Binder_MultiSelect<EnclosingItem_, Prop, InnerType>> {..._props} {...props}/>;
    }
    render() {
