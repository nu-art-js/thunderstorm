...
import { ModuleFE_BaseApi } from "@nu-art/thunder-db-api-frontend/modules/db-api-gen/ModuleFE_BaseApi";
...
export class ModuleFE_EditableTest_Class extends ModuleFE_BaseApi<DBProto_EditableTest> implements ApiDefCaller<ApiStruct_EditableTest> {
