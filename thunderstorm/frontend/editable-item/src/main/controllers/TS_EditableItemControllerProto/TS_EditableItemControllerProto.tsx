...
import { EditableDBItemV3 } from '../../core/EditableItem.js';
import { InferProps, InferState, ModuleFE_BaseApi, ProtoComponent } from '@nu-art/thunderstorm-frontend';
...
import { ProtoDef_Selection } from '../../page/Page_ItemsEditor/index.js';
 ...
 */
export class TS_EditableItemControllerProto<Proto extends DBProto<any>, EditorProps extends {} = {}, Props extends Props_EditableItemControllerProto<Proto, EditorProps> = Props_EditableItemControllerProto<Proto, EditorProps>> extends ProtoComponent<ProtoDef_Selection, Props, EditableRef<Proto['uiType']>> {
