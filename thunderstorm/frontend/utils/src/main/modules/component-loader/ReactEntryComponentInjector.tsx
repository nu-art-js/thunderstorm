...
import { OnRequestListener } from "@nu-art/thunder-db-api-shared/request-types";
...
export class ReactEntryComponentInjector extends React.Component<Props, State> implements OnRequestListener {
