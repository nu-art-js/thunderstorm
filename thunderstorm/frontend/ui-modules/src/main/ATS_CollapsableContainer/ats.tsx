...
class Component extends ComponentSync<Props, State> {
    ...
    private test_Controlled = () => {
        return <TS_PropRenderer.Vertical label={'Singular Collapsable - Controlled'}>
			<TS_CollapsableContainerV2 headerRenderer={'I\'m a single container!'} containerRenderer={lorem} collapsed={this.state.collapsed} onCollapseToggle={collapsed => this.setState({ collapsed: !collapsed })}/>
		</TS_PropRenderer.Vertical>;
    };
