...
import { ApiDef, TypedApi } from "@nu-art/thunder-db-api-shared";
import { BadImplementationException, composeUrl } from '@nu-art/ts-common';
// noinspection TypeScriptPreferShortImport
import { BaseHttpModule_Class, BaseHttpRequest, HttpException } from "@nu-art/thunder-db-api-shared";
// noinspection TypeScriptPreferShortImport
import { gzipSync } from 'zlib';
import { ApiError_GeneralErrorMessage, ApiErrorResponse, ResponseError } from '@nu-art/ts-common/core/exceptions/types';
export class ModuleFE_XHR_Class extends BaseHttpModule_Class {
    init() {
        super.init();
...
class XhrHttpRequest<Binder extends TypedApi<any, any, any, any>> extends BaseHttpRequest<Binder> {
