 ...
 */
import { _keys, ApiException, BadImplementationException, composeUrl, currentTimeMillis, dispatch_onApplicationException, isErrorOfType, Logger, LogLevel, MimeType_json, MUSTNeverHappenException, Promise_all_sequentially, tsValidate, TypedMap, ValidationException, ValidatorTypeResolver } from '@nu-art/ts-common';
...
export abstract class ServerApi<API extends TypedApi<any, any, any, any>> extends Logger {
...
export abstract class ServerApi_Get<API extends QueryApi<any, any, any, any, HttpMethod_Query>> extends ServerApi<API> {
    protected constructor(apiDef: ApiDef<API>) {
        super(apiDef);
    }
}
export abstract class ServerApi_Post<API extends BodyApi<any, any, any, any, HttpMethod_Body>> extends ServerApi<API> {
    protected constructor(apiDef: ApiDef<API>) {
        super(apiDef);
    }
}
export class ServerApi_Redirect<API extends TypedApi<any, any, any, any>> extends ServerApi<any> {
...
export class _ServerQueryApi<API extends QueryApi<any, any, any, any, HttpMethod_Query>> extends ServerApi_Get<API> {
...
export class _ServerBodyApi<API extends BodyApi<any, any, any, any, HttpMethod_Body>> extends ServerApi_Post<API> {
