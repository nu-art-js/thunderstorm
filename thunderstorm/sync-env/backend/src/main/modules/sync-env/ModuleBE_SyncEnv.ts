import { ApiException, arrayToMap, BadImplementationException, Dispatcher, Minute, Module, MUSTNeverHappenException, RuntimeModules, TypedMap } from '@nu-art/ts-common';
import { ModuleBE_Firebase } from '@nu-art/firebase-backend';
import { addRoutes, AxiosHttpModule, createBodyServerApi, createQueryServerApi, ModuleBE_BackupDocDB, ModuleBE_BaseApi_Class, ModuleBE_BaseDB, Storm } from "@nu-art/thunder-db-api-backend";
import { ApiDef_SyncEnv, Request_FetchFirebaseBackup, Request_FetchFromEnv, Request_GetMetadata, Response_FetchBackupMetadata } from '@nu-art/thunderstorm-sync-env-shared';
import { Transform, Writable } from 'stream';
import { firestore } from 'firebase-admin';
import { HttpCodes } from '@nu-art/ts-common/core/exceptions/http-codes';
import { MemKey_HttpRequest } from "@nu-art/thunder-db-api-backend/modules/server/consts";
import { ApiDef, ApiModule, DBModuleType, HeaderKey_Authorization, HttpMethod, QueryApi, Response_BackupDocs } from "@nu-art/thunder-db-api-shared";
type Config = {
...
const dispatch_OnSyncEnvCompleted = new Dispatcher<OnSyncEnvCompleted, '__onSyncEnvCompleted'>('__onSyncEnvCompleted');
class ModuleBE_SyncEnv_Class extends Module<Config> {
    constructor() {
        super();
