...
import { ApiCallerRouter, ApiDefCaller, Default_ServerInfoNodePath, ServerInfoFirebaseState } from "@nu-art/thunder-db-api-shared";
...
class ModuleFE_ServerInfo_Class extends Module implements ApiDefCaller<ApiStruct_ServerInfo> {
