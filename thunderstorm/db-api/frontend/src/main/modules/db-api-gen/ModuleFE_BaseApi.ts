...
import { ApiDefCaller, ApiStruct_DBApiGenIDBV3, BaseHttpRequest, HttpException, TypedApi } from "@nu-art/thunder-db-api-shared";
import { DBApiDefGeneratorIDBV3 } from '@nu-art/thunder-db-api-shared';
import { DBApiFEConfig } from '../../core/db-api-gen/db-def.js';
import { ThunderDispatcher } from "@nu-art/thunder-db-api-frontend";
 ...
 */
export abstract class ModuleFE_BaseApi<Proto extends DBProto<any>, _Config extends object = object, Config extends _Config & DBApiFEConfig<Proto> = _Config & DBApiFEConfig<Proto>> extends ModuleFE_BaseDB<Proto, Config> implements ApiDefCaller<ApiStruct_DBApiGenIDBV3<Proto>> {
    // @ts-ignore
