...
import { ApiDef_CollectionActions, ApiStruct_CollectionActions } from '@nu-art/thunderstorm-shared/collection-actions/api-def';
import { apiWithBody } from '../core/typed-api.js';
class ModuleFE_CollectionActions_Class extends Module {
