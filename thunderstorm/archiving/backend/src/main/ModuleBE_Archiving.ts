import { BadImplementationException, batchActionParallel, currentTimeMillis, Day, DB_Object, dbIdLength, DBProto, deepClone, generateHex, Hour, Proto_DB_Object, removeDBObjectKeys, RuntimeModules } from '@nu-art/ts-common';
...
import { ApiDef_Archiving, RequestBody_HardDeleteUnique, RequestQuery_DeleteAll, RequestQuery_GetHistory } from '@nu-art/thunderstorm-archiving-shared';
 ...
 */
export class ModuleBE_ArchiveModule_Class<DBType extends DB_Object> extends ModuleBE_FirestoreListener<DBType> {
    ...
    }; // Module mapper, mapping collection name to module
    /**
