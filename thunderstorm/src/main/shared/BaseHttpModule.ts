...
export abstract class BaseHttpModule_Class<Config extends HttpConfig = HttpConfig>
	...
	abstract createRequest<Binder extends ApiTypeBinder<any, any, any, any> = ApiTypeBinder<void, void, void, {}>>(method: HttpMethod, key: string, data?: any): BaseHttpRequest<DeriveRealBinder<Binder>,any>
