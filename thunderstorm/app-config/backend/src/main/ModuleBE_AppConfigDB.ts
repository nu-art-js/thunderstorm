import { DB_AppConfig, DBDef_AppConfig, DBProto_AppConfig } from '@nu-art/thunderstorm-app-config-shared';
...
export class ModuleBE_AppConfigDB_Class extends ModuleBE_BaseDB<DBProto_AppConfig, Config> {
