import { apiWithQuery, ModuleFE_BaseApi } from "@nu-art/thunder-db-api-frontend";
import { ApiDef_AppConfig, ApiStruct_AppConfig, DB_AppConfig, DBDef_AppConfig, DBProto_AppConfig } from '@nu-art/thunderstorm-app-config-shared';
import { BadImplementationException, cloneObj, TypedKeyValue } from '@nu-art/ts-common';
import { DispatcherDef, ThunderDispatcherV3 } from "@nu-art/thunder-db-api-frontend/core/db-api-gen/types";
import { ApiDefCaller } from "@nu-art/thunder-db-api-shared/types";
...
export class ModuleFE_AppConfig_Class extends ModuleFE_BaseApi<DBProto_AppConfig> implements ApiDefCaller<ApiStruct_AppConfig> {
