...
projectLibraries=(ts-common testelot firebase thunderstorm db-api-generator storm live-docs user-account permissions app-shared test-backend push-pub-sub bug-report)
