...
exports.runTest = testelot_1.__custom(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                session = backend_1.FirebaseModule.createAdminSession();
                firestore = session.getFirestore();
                collection = firestore.getCollection('test-backend', ['a']);
                return [4 /*yield*/, collection.deleteAll()];
            case 1:
                _a.sent();
                return [4 /*yield*/, collection.upsert({ a: 1 })];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
