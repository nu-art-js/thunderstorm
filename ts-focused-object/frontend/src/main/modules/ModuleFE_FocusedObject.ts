...
import { apiWithBody, ThunderDispatcher } from "@nu-art/thunder-db-api-frontend/index";
...
export class ModuleFE_FocusedObject_Class extends Module implements OnLoginStatusUpdated {
