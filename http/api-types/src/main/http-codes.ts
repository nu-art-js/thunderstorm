...
import {ApiError_GeneralErrorMessage} from './error-types.js';
 ...
 * - Custom status codes (444, 459-463, 490, 555, 560-561, 598-599)
...
export const HttpCodes = {
	...
	_4XX: {
		...
		//custom
		PASSWORD_ASSERTION: createGeneralError(444),
	...
	_5XX: {
		...
		//custom
		DEBUG_WHO_CALLED_THIS: createGeneralError(555),
		BAD_IMPLEMENTATION: createGeneralError(560),
		IMPLEMENTATION_MISSING: createGeneralError(561),
		SHOULD_NOT_HAPPENED: createGeneralError(598),
		MUST_NEVER_HAPPENED: createGeneralError(599),
	},
} as const;
