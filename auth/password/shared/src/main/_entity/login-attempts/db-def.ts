...
import {DatabaseDef_LoginAttempt, LoginStatus_Failed, LoginStatus_Success} from './types.js';

const Validator_ModifiableProps: DatabaseDef_LoginAttempt['modifiablePropsValidator'] = {
...
const Validator_GeneratedProps: DatabaseDef_LoginAttempt['generatedPropsValidator'] = {};

export const DBDef_LoginAttempt: Database<DatabaseDef_LoginAttempt> = {
