...
import {SessionKeyFE_PasswordAuth} from '../../consts.js';
...
export class Component_ChangePassword
	...
	protected deriveStateFromProps(nextProps: any, state: State): State {
		const passwordAuth = SessionKeyFE_PasswordAuth.get();
		state.shouldGiveCurrentPassword = passwordAuth?.hasPassword ?? false;
		return state;
	}
