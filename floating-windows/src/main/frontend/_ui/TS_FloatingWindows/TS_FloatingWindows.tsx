...
type State = {
	windowModels: typeof ModuleFE_FloatingWindows['windowModels'];
};
...
type Props_FloatingWindow = { model: typeof ModuleFE_FloatingWindows['windowModels'][number] };

class TS_FloatingWindow
	extends ComponentSync<Props_FloatingWindow>
