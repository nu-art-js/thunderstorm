...
replaceStringInFiles . "from "@nu-art/thunderstorm/frontend"" "from \"@nu-art/thunderstorm/frontend\"" node_modules dist dist-test .idea .stuff .trash .fork .firebase .config dev-tools ts-common testelot thunderstorm firebase .git
