...
export class ModuleFE_Firebase_Class
	extends Module<ConfigType> {

	private sessions: { [projectId: string]: FirebaseSessionFE } = {};
	private swSession?: SwFirebaseSessionFE;

	async createSwSession(): Promise<SwFirebaseSessionFE> {
	...
	private async createLocalSession(token?: string): Promise<FirebaseSessionFE> {
	...
	private async createSessionWithConfigs(config: FirebaseConfig, token?: string): Promise<FirebaseSessionFE> {
