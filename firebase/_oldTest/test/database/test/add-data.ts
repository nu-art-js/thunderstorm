...
export const addData = (model: ModelDb) => myDb.processDirty(model.label, async db => {
...
export const scenarioSet = myDb.processClean('Set an object over another overwrites', async db => {
...
export const scenarioUpdate = (obj1: ModelDb, obj2: ModelDb) => myDb.processClean('Update an object over another just patches', async db => {
...
export const scenarioEscape = myDb.processDirty('Do I need to escape my values?', async db => {
