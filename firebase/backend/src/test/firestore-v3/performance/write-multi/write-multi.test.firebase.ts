...
const runTestCase = (testCase: typeof TestCases_FirestoreV2_Performance_WriteMulti[number]) => () => runSingleTestCase(test_FirestoreV2_Performance_WriteMulti, testCase);

describe('Firestore v2 - Performance WriteMulti', () => {
	TestCases_FirestoreV2_Performance_WriteMulti.forEach(testCase => {
