...
import {ApiCallerEventTypeV2, BaseDB_ApiCallerV2, DBApiFEConfig} from '@nu-art/db-api-generator/frontend';
...
export class ModuleFE_Workspace_Class
	extends BaseDB_ApiCallerV2<DB_Workspace, 'key' | 'accountId', Config> {
