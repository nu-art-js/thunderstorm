...
exports.createApisForDBModuleV3 = exports.ModuleBE_BaseApiV3_Class = void 0;
 ...
 */
class ModuleBE_BaseApiV3_Class extends ts_common_1.Module {
    ...
    init() {
        const apiDef = (0, shared_1.DBApiDefGeneratorIDBV3)(this.dbModule.dbDef);
...
exports.ModuleBE_BaseApiV3_Class = ModuleBE_BaseApiV3_Class;
const createApisForDBModuleV3 = (dbModule) => {
    return new ModuleBE_BaseApiV3_Class(dbModule);
};
exports.createApisForDBModuleV3 = createApisForDBModuleV3;
//# sourceMappingURL=ModuleBE_BaseApiV3.js.map