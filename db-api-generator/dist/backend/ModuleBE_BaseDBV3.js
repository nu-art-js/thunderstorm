...
exports.ModuleBE_BaseDBV3 = void 0;
 ...
 */
class ModuleBE_BaseDBV3 extends ts_common_1.Module {
    constructor(dbDef, appConfig) {
        ...
        const config = (0, v3_db_def_1.getModuleBEConfigV3)(dbDef);
    ...
    init() {
        var _a;
        const firestore = backend_1.ModuleBE_Firebase.createAdminSession((_a = this.config) === null || _a === void 0 ? void 0 : _a.projectId).getFirestoreV3();
    ...
    async upgradeCollection(forceUpgrade) {
        ...
        let items = (0, ts_common_1.filterDuplicates)(docs.map(d => d.data), ts_common_1.dbObjectToId_V3);
...
exports.ModuleBE_BaseDBV3 = ModuleBE_BaseDBV3;
//# sourceMappingURL=ModuleBE_BaseDBV3.js.map