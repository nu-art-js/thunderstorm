import { apiWithBody, ModuleFE_BaseApi, ThunderDispatcher } from "@nu-art/thunder-db-api-frontend/index";
...
export class ModuleFE_Assets_Class extends ModuleFE_BaseApi<DBProto_Assets> {
