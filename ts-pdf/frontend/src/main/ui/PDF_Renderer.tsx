...
import { ComponentAsync, TS_Loader } from "@nu-art/web-client/index";
...
export class PDF_Renderer extends ComponentAsync<Props, State> {
    ...
    render() {
        return <>
			<div className={'pdf-renderer'} ref={instance => {
                if (!instance)
                    return;
                if (!this.ctx)
