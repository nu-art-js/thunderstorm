...
export class ModuleBE_MessageDB_Class
	...
	protected async preWriteProcessing(dbInstance: DatabaseDef_Message['uiType'], originalDbInstance: DatabaseDef_Message['dbType'], transaction?: FirebaseFirestore.Transaction) {
