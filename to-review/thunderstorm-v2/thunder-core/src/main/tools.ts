...
import {BadImplementationException, composeUrl, ImplementationMissingException, TypedMap} from '@nu-art/ts-common';
...
export function openUrl(url: string | { url: string, params?: TypedMap<(() => string) | string | undefined> }, target?: UrlTarget) {
	if (!window)
