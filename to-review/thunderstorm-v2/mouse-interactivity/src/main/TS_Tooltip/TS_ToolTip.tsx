...
import {Model_ToolTip, mouseInteractivity_ToolTip, ToolTipListener} from '../types.js';
...
export class TS_ToolTip
	...
	render() {
		...
		if (!model || !open)
			return '';
		return <div className={'ts-tooltip__content'} id={model.id} ref={this.ref} onMouseEnter={this.onContentMouseEnter} onMouseLeave={this.onContentMouseLeave}
