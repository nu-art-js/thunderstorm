...
class Component
	...
	private test_Singular = () => {
		return <TS_PropRenderer.Vertical label={'Singular Collapsable - Uncontrolled'}>
			<TS_CollapsableContainer headerRenderer={'I\'m a single container!'} containerRenderer={lorem}/>
	...
	private test_Animated = () => {
		return <TS_PropRenderer.Vertical label={'Singular Collapsable - Animated'}>
			<TS_CollapsableContainer headerRenderer={'I\'m an animated container!'} containerRenderer={lorem} animated={true}/>
		</TS_PropRenderer.Vertical>;
	};
	private test_Multiple = () => {
		return <TS_PropRenderer.Vertical label={'Multiple Collapsable'}>
			<TS_CollapsableContainer headerRenderer={'Multiple 1'} containerRenderer={lorem}/>
			<TS_CollapsableContainer headerRenderer={'Multiple 2'} containerRenderer={lorem}/>
		</TS_PropRenderer.Vertical>;
	};
	private test_Nesting = () => {
		return <TS_PropRenderer.Vertical label={'Nested Collapsable'}>
			<TS_CollapsableContainer headerRenderer={'Parent'} containerRenderer={() => <>
				<TS_CollapsableContainer headerRenderer={'Child 1'} containerRenderer={lorem}/>
				<TS_CollapsableContainer headerRenderer={'Child 2'} containerRenderer={lorem}/>
			</>}/>
		</TS_PropRenderer.Vertical>;
	};
